...
(function () {
  ...
  window.v2AjPintar = () => {
    ...
    if (B && B.pintarComprobacion) B.pintarComprobacion();
  };
  window.v2AjSec = (sec) => {
    ...
    if (sec === "sync" && B) {
      ...
      // después de guardar, lo que cuenta es lo que pasó, no un panel en blanco.
      if (B.pintarComprobacion) B.pintarComprobacion();
    }
  };
